...
import com.denes.myflower.data.AlarmReminderContract;
import com.denes.myflower.reminder.AlarmScheduler;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (mTitleText.getText().toString().length() == 0){
                    ...
                    saveReminder();
                    Intent i = new Intent(AddReminderActivity.this, AlarmMainActivity.class);
    ...
    private void deleteReminder() {
        ...
        if (mCurrentReminderUri != null) {
            ...
            if (rowsDeleted == 0) {
                ...
                Toast.makeText(this, "Deleted your reminder",
                        Toast.LENGTH_SHORT).show();
            }
        }
